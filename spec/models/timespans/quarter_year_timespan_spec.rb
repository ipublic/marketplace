...
module Timespans
	RSpec.describe QuarterYearTimespan, type: :model do
    ...
    describe "A new model instance" do
      ...
      context "with invalid year values" do
        subject { described_class.new(year: year_too_large, quarter: quarter) }
        ...
        subject { described_class.new(year: year_too_small, quarter: quarter) }
